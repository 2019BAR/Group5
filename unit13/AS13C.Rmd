...
&emsp; 答：臨界機率 = 0.16 ，期望報酬 = -2360。<br>
&emsp; 【B】 什麼都不做時，臨界機率和期望報酬各是多少？<br>
&emsp; 答：臨界機率 = 1 ， 期望報酬 = -3300。<br>
&emsp; 【C】 每位保戶都做時，臨界機率和期望報酬各是多少？<br>
&emsp; 答：臨界機率 = 0 ， 期望報酬 = -2630。<br>
&emsp; 【D】 以上哪一種做法期的望報酬比較高？<br>
&emsp; 答：什麼都做的做法期望報酬比較高。<br>
&emsp; 【E】 在所有的商務情境都是這種狀況嗎？<br>
&emsp; 答：那就要看做的成本為多少而定。<br><br>
藉由調整報酬矩陣：<br>
&emsp; 【F】 模擬出「全不做」比「全做」還要好的狀況<br>
&emsp; 答：其他變數不變下，把FP從-15到-20，就會有「全不做」比「全做」還要好的狀況。<br>
&emsp; 【G】 並舉出一個會發生這種狀況的商務情境<br>
&emsp; 答：在公司考慮是否要將員工的電腦全部升級時，就可能會發生「全部電腦升級」無法帶來超越電腦升級成本的效益，導致電腦不升級比較好。<br><br>
有五種成本分別為`$5, $10, $15, $20, $30`的介入方法，它們分別可以將風險成本從`$100`降低到`$70, $60, $50, $40, $25` ...<br>
&emsp; 【H】 它們的最佳期望報酬分別是多少？<br>
&emsp; 答：第1個情況 ： FP = -5，TP = -75；<br>
&emsp; 臨界機率 = 0.16 ， 期望報酬 = -2830。<br>
&emsp; 第2個情況 ： FP = -10，TP = -70；<br>
&emsp; 臨界機率 = 0.36 ， 期望報酬 = -2830。<br>
&emsp; 第3個情況 ： FP = -15，TP = -65；<br>
&emsp; 臨界機率 = 0.36 ， 期望報酬 = -2775。<br>
&emsp; 第4個情況 ： FP = -20，TP = -60；<br>
&emsp; 臨界機率 = 0.36 ， 期望報酬 = -2720。<br>
&emsp; 第5個情況 ： FP = -30，TP = -55；<br>
&emsp; 臨界機率 = 0.36 ， 期望報酬 = -2700。<br>
&emsp; 【I】 哪一種介入方法的最佳期望報酬是最大的呢？<br>
&emsp; 答：第5個情況：FP = -30，TP = -55。<br>
</p class="qiz">
